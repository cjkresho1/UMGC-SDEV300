...
def get_positive_float(float_prompt):
    is_positive_float = False
    while not is_positive_float:
        try:
            user_float = int(input(float_prompt))
            if user_float > 0:
...
if __name__ == '__main__':
    ...
    while True:
        ...
        print("")
        if user_val == 1:
            pass_length = get_integer_positive("What length should the password be: ")
            ...
            precision = get_integer_positive("Enter number of decimal points on output: ")
            ...
            leg1 = get_positive_float("Enter the length of the first leg of the triangle: ")
            leg2 = get_positive_float("Enter the length of the second leg of the triangle: ")
            angel = get_positive_float("Enter the angel of the angel between the two legs: ")
            third_leg = calc_triangle_leg(leg1, leg2, angel)
            print(f"The third leg of the triangle is {third_leg}")
        elif user_val == 5:
            cyl_radius = get_positive_float("Enter the radius of the cylinder: ")
            cyl_height = get_positive_float("Enter the height of the cylinder: ")
